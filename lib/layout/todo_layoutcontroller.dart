...
import 'package:innhacks/modules/my_events/my_event_screen.dart';
import 'package:innhacks/modules/done_events/done_events.dart';
import 'package:innhacks/modules/archive_events/archive_task.dart';
import '../model/event.dart';
import '../shared/componets/constants.dart';
import '../shared/network/local/TodoDbHelper.dart';
import '../shared/network/local/cashhelper.dart';
import '../shared/network/local/notification.dart';
...
class TodoLayoutController extends GetxController {
  ...
  Future<void> onReady() async {
    ...
    print("token messaging -- $devicetoken");
